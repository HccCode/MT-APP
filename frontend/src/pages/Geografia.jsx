...
export default function Geografia({ token, estructuraGeografica, cargarGeographyDB, handleLogout, esAdmin }) {
  ...
  return (
    // FIX APLICADO: h-[calc(100vh-74px)] elimina el scroll global y se lo delega a los paneles internos
    <main className="flex flex-col h-[calc(100vh-74px)] min-h-0 overflow-hidden bg-[#070b19] relative w-full p-4 md:p-6 space-y-6">
      ...
      {/* ÁREA DE CONTENIDO DIVIDIDA EN 3 COLUMNAS CON SCROLL INDEPENDIENTE */}
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6 min-h-0 overflow-hidden">
        
        {/* ==================== COLUMNA 1: REGIONES ==================== */}
        <div className="bg-[#0b132b]/50 border border-slate-800 rounded-xl p-5 flex flex-col min-h-0 overflow-hidden shadow-lg">
          {esAdmin ? (
          ...
          <div className="relative mt-4 shrink-0 mb-3">
          ...
          <div className="flex-1 overflow-y-auto space-y-1.5 border-t border-slate-800 pt-3 custom-scrollbar">
        ...
        <div className="bg-[#0b132b]/50 border border-slate-800 rounded-xl p-5 flex flex-col min-h-0 overflow-hidden shadow-lg">
          ...
          <div className="relative shrink-0 mb-3 mt-4 border-t border-slate-800 pt-3">
            <Search className="w-3.5 h-3.5 text-slate-500 absolute left-2.5 top-5" />
        ...
        <div className="bg-[#0b132b]/50 border border-slate-800 rounded-xl p-5 flex flex-col min-h-0 overflow-hidden shadow-lg">
          ...
          <div className="border-t border-slate-800 pt-3 mt-3 flex-1 flex flex-col min-h-0 overflow-hidden">

        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar text-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div className="space-y-3 bg-[#050814] p-4 rounded-lg border border-slate-800/60 shadow-inner">
              ...
              <div><span className="text-slate-500 text-[10px] block font-bold">RUTA</span><span className="text-slate-200 font-mono font-bold tracking-wide">{puertoDetalle.RUTA || '-'}</span></div>
